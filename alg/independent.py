...
class rl_alg_independent:
    ...
    def rl_episode(self, max_steps_this_episode=100, idx=0):
        ...
        if self._num_episodes % 1000 == 0 and self.mode == "Train":
            ...
            with open('Data/eps_records_v1_id' + self.label, 'wb') as f:
    ...
    def save_parameters(self, idx):
        torch.save(self.actor.state_dict(), 'Data/MAAC_v8_trainedActor_id'+ self.label)
        torch.save(self.critic.state_dict(), 'Data/MAAC_v8_trainedCritic_id'+ self.label)
